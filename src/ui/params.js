/* ================= パラメータ調整室(モーダル) ================= */
import { CONST } from '../core/index.js';
...
for (const d of PARAM_DEFS) if (d.key) PARAM_DEFAULTS[d.key] = CONST[d.key];
...
export function setupParams(onApply){
